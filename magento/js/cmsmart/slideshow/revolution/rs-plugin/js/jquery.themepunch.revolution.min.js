	...
	$.fn.extend({
		...
		var defaults = {	
			...
			return this.each(function() {
				...
				opt.slideamount = container.find('ul:first li.netbase').length;
		...
		function containerResized(container,opt) {
			...
			container.find('.defaultimg').each(function(i) {
						...
						var actsh = container.find('li.netbase:eq('+opt.act+') .slotholder');
						var nextsh = container.find('li.netbase:eq('+opt.next+') .slotholder');
		...
		function createThumbs(container,opt) {
			...
			container.find('ul:first li.netbase').each(function(i) {
							var li= container.find("ul:first li.netbase:eq("+i+")");
			...
			var max=minwidth*container.find('ul:first li.netbase').length;
		...
		function createBullets(container,opt) {
			...
			container.find('ul:first li.netbase').each(function(i) {
							var src=container.find("ul:first li.netbase:eq("+i+") img:first").attr('src');
		...
		function prepareSlides(container,opt) {
			...
			container.find('ul:first >li.netbase').each(function(j) {
				var li=$(this);
			...
			container.find('ul:first li.netbase >img').each(function(j) {
		...
		function swapSlide(container,opt) {
			...
			var actli = container.find('li.netbase:eq('+opt.act+')');
			var nextli = container.find('li.netbase:eq('+opt.next+')');
						...
						nextli.find('.caption').each(function(i) {
							   ...
							   var imh = 0;
								...
								if (nextcaption.hasClass('lft')) {
									...
									nextcaption.css({'opacity':1,'left':(xbw*nextcaption.data('x')+offsetx)+'px','top':(-500 - imh)+"px"});
