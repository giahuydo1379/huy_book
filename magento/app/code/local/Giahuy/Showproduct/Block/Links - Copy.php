...
class Giahuy_Showproduct_Block_Links extends Mage_Catalog_Block_Product_List
...
/**
  ...
  */
	...
	public function getProductPrice()
	{
		...
		$collection = $collection->addFieldToFilter('price',array('from'=>$a,'to'=>$b));
		$collection->addAttributeToFilter('status', Mage_Catalog_Model_Product_Status::STATUS_ENABLED);
		$collection->addFieldToFilter('visibility', Mage_Catalog_Model_Product_Visibility::VISIBILITY_BOTH);
		$collection->addAttributeToSelect(array('name','image', 'price','special_price', 
										'special_packing','prosort','description',
