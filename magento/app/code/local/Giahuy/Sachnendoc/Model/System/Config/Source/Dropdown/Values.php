...
class Giahuy_Sachnendoc_Model_System_Config_Source_Dropdown_Values
{
    public function getAllCategoryId()
    {
        $_categories = Mage::getModel('catalog/category')->getCollection()->addAttributeToSelect('name,id')->addIsActiveFilter();
        ;
        $data = array();
