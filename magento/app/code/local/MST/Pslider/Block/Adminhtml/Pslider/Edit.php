...
class MST_Pslider_Block_Adminhtml_Pslider_Edit extends Mage_Adminhtml_Block_Widget_Form_Container
{
    ...
    public function getHeaderText()
    {
        if (Mage::registry('pslider_data') && Mage::registry('pslider_data')->getId()) {
            return Mage::helper('pslider')->__("Edit Item '%s'", $this->htmlEscape(Mage::registry('pslider_data')->getTitle()));
        } else {
            return Mage::helper('pslider')->__('Add Item');
        }
    }
}